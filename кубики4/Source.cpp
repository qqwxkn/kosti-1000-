...
int main()
{
    setlocale(LC_ALL, "");
    int mass1[6], mass2[6];
    int vibor_igry, vibor, vibor1, vibor111, vibor2, vibor3, vibor4, vibor5, points_all = 0, points_all1 = 0, points1 = 0, points2 = 0, points3 = 0, points4 = 0, points5 = 0, n = 5, score1 = 0, score2 = 0;
    ...
    printf("\n\nИгра в кости 1000 (классика,без бочек)\n\n");
    printf("\nрежимы игры:\n");
    printf("\n1 - против пк\n2 - против игрока2\n");
    printf("\nвыберите режим игры: ");
